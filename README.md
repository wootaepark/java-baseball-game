...
### ✏️ 소감
이번이 두번째 java 를 활용한 프로젝트라서 다소 쉬운 감은 있었지만 오히려 지난번 프로젝트의 경험이 있어서
그런지 처음부터 클래스 및 메서드를 설계할 때 생각을 좀 더 하게된것 같습니다.
하지만 이 역시 쉽지 않았으며 수많은 코딩을 통한 경험 축척만이 답인 것 같습니다.
여러 튜터님께서도 정해진 클래스 규격은 없으며 개발자의 주관에 따라 달라질 수 있다고 
하셨으니 나만의 확실한 주관을 가지고 또한 그것만을 고집하지 않는 남의 생각도
잘 받아 들일 수 있는 개발자가 되어야겠다고 생각했습니다.
